...
// Type definitions
type Category = 'programming' | 'design' | 'business' | 'marketing' | 'communication' | 'languages' | 'music' | 'other';
...
const CreateListingPage: React.FC = () => {
  ...
  const timeSlots: TimeSlot[] = Array.from({ length: 24 }, (_, i) => 
    `${i.toString().padStart(2, '0')}:00` as TimeSlot
  );
      ...
      <div className="container">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-7 gap-2 mt-1.5">
                    {days.map((day) => (
                      <Button
                        ...
                        className={`${selectedDays.includes(day) ? 'border-blue-1 bg-sky-1 text-blue-1' 
            ...
            <Card className="bg-white">
              <CardHeader>
                <CardTitle>Prerequisites & Materials</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                ...
                <div>
                  ...
                  <Textarea 
                    id="materials"
                    placeholder="List any materials or resources you'll provide..."
                    className="mt-1.5"
            ...
            <div className="flex gap-4 justify-end">
              <Button className="secondary-btn" variant="outline" type="button" asChild>
